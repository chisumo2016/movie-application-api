        ...
        <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
            ...
            <div class="md:ml-24">
                ...
                <div class="flex flex-wrap items-center text-gray-400 text-sm">
                    ...
                    {{--                <span class="ml-2">{{ $tvshow['vote_average'] * 10 . '%' }}</span>--}}
                    <span class="mx-2">|</span>
                    <span>{{ $tvshow['first_air_date']}}</span>
                    {{--                <span>{{ \Carbon\Carbon::parse($tvshow['release_date']) ->format('M d,Y')}}</span>--}}
                    <span class="mx-2">|</span>
                    <span>
                        {{ $tvshow['genres'] }}
...
{{--                    <h4 class="text-white font-semibold">Features Cast</h4>--}}
                ...
                <div x-data="{ isOpen: false}">
                    @if( count( $tvshow['videos']['results'] ) > 0 )
                        <div class="mt-12">
                            <a href="https://www.youtube.com/watch?v={{ $tvshow['videos']['results'][0]['key'] }}"  class="flex inline-flex item-content-center bg-orange-500 text-gray-900 rounded font-semibold px-5 py-4 hover:bg-orange-700 transition ease-in-out duration-150">
...
{{--                                        @if($loop->index < 9) @else @break  @endif--}}
                        <div class="mt-8">
                            <a
                                @click.prevent="
                            isOpen = true
