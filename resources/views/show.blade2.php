        ...
        <img src="/img/parasite.jpg" alt="" class="w-64 md:w-96">
            <div class="md:ml-24">
                ...
                <span>March, 31 ,2020</span>
                 <span class="mx-2">|</span>
                 <span>Action, Thriller,  Dram</span>
            </div>
                <p class="text-gray-300 mt-8">
                    Lorem ipsum dolor sit amet, consectetur adipisicing elit. Asperiores at debitis excepturi fugit, ipsa ipsam nobis officia provident sunt tempore? A ab consequatur consequuntur earum esse hic pariatur ut. A ab, accusantium commodi consectetur consequatur, eos ex fuga ipsam, iure maxime minus molestiae nam quaerat rerum soluta ullam vel? Itaque?
                </p>

                <div class="mt-12">
                    <h4 class="text-white font-semibold">Features Cast</h4>
                    <div class="flex mt-4">
                        <div>
                            <div>Boong Jin</div>
                ...
                <div class="mt-12">
                    <button class="flex item-content-center bg-orange-500 text-gray-900 rounded font-semibold px-5 py-4 hover:bg-orange-700 transition ease-in-out duration-150">
